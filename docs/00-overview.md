...
| 6 | [06-ralph-tornado-skill.md](./06-ralph-tornado-skill.md) | ralph-tornadoスキル | 計画→マイルストーン変換、5フェーズパイプライン |
...
8. **ralph-tornado スキル** - 計画ファイルからマイルストーン変換・起動・監視を自動化
